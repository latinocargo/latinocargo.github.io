(function($) {
    ...
    new WOW().init();
        ...
        $("ul.slide-menu-items li.has-sub, ul.slide-menu-items li.menu-item-has-children, ul.slide-menu-items li.page_item_has_children, ul.slide-menu-items li.has-child").click(function () {
            $('ul.slide-menu-items li.has-sub ul, ul.slide-menu-items li.menu-item-has-children ul, ul.slide-menu-items li.page_item_has_children ul, ul.slide-menu-items li.has-child ul').not($(this).children("ul").slideToggle()).hide();  
        });
